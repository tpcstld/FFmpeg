...
typedef struct MJpegContext {
    ...
    uint8_t *huff_table_ids;         ///< The Huffman table ids associated with the data.
    uint8_t *huff_codes;             ///< The exponents.
    uint16_t *huff_mants;            ///< The mantissas.
    int huff_ncode;                  ///< Number of current entries in the buffer.
    unsigned int huff_table_ids_cap; ///< Number of total spaces in the buffer.
    unsigned int huff_codes_cap;     ///< Number of total spaces in the buffer.
    unsigned int huff_mants_cap;     ///< Number of total spaces in the buffer.
